$(function(){var n=null,t;$("#loginModal").on("show.bs.modal",function(t){var i=$(t.relatedTarget);n=i.data("redirect")});$("#submitLogin").on("click",function(t){t.preventDefault();var i=$("#loginForm").serializeJSON();$.ajax({type:"post",url:"/api/users/authenticate",data:JSON.stringify(i),contentType:"application/json"}).done(function(t){Cookies.set("token",t.token);Cookies.set("username",t.username);window.location=n==null?window.location:n}).fail(function(){$("#loginError").empty();var n=`<div class="alert alert-danger alert-dismissible" id="errorMessage">
